...
const all = () => __awaiter(void 0, void 0, void 0, function* () {
    const allRoleList = yield (0, utils_1.handleExec)(role_1.getAllRole, null);
...
const list = (req) => __awaiter(void 0, void 0, void 0, function* () {
    const roleList = yield (0, utils_1.handleExec)(role_1.getRoleList, req);
    return new resModel_1.SuccessModel({
        roleList
    });
});
...
const save = (req) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield (0, utils_1.handleExec)(role_1.saveRole, req);
    return new resModel_1.SuccessModel({
        result
    });
});
...
const Delete = (req) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield (0, utils_1.handleExec)(role_1.deleteRole, req);
    return new resModel_1.SuccessModel({
        result
    });
});
