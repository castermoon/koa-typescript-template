...
exports.handExec = exports.handelSql = exports.handleXss = void 0;
...
const handelSql = (sql) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.handelSql = handelSql;
function handExec(func, req) {
